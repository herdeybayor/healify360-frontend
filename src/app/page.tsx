        ...
        <div className="">
            ...
            <main>
                <div className="max-w-[1100px] mx-auto md:mt-16 mt-8 text-center px-4">
                    <Button variant="outline" asChild className="text-sm mx-auto text-[#00AC30] font-semibold space-x-1">
                        <Link href="/login">
                ...
                <div className="md:mt-12 mt-6 relative">
                    <div className="max-w-[1400px] mx-auto md:grid grid-cols-2 items-center px-4">
                        ...
                        <div>
                            <Image src="/patient-select-time.png" width={760} height={660} className="aspect-video" alt="" />
                        </div>
                    </div>
                </div>
