        ...
        <div className="p-2 flex justify-between w-full items-center gap-2">
            ...
            <AnimatePresence initial={false}>
                ...
                {message.trim() ? (
                    <Link
                        href="#"
                        className={cn(buttonVariants({ variant: "ghost", size: "icon" }), "h-9 w-9", "dark:bg-muted dark:text-muted-foreground dark:hover:bg-muted dark:hover:text-white shrink-0")}
                        onClick={handleSend}
                    >
