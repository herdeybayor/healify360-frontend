                    ...
                    isCollapsed ? (
                                ...
                                <TooltipTrigger asChild>
                                    <Link
                                        ...
                                        className={cn(
                                            ...
                                            link.variant === "outline" && "dark:bg-muted dark:text-muted-foreground dark:hover:bg-muted dark:hover:text-white"
                                        )}
                                    >
                        ...
                        <Link
                            ...
                            className={cn(
                                ...
                                link.variant === "outline" && "dark:bg-muted dark:text-white dark:hover:bg-muted dark:hover:text-white shrink",
                                "justify-start gap-4"
                            )}
                        >
                            <Avatar className="flex justify-center items-center">
